...
<body>
	...
	<div id="box_1" class="mymagicoverbox_fenetre" style="left:-225px; width:450px;">
		...
		<div class="mymagicoverbox_fenetreinterieur" style="height:200px; ">
			<div align="center">
					...
					<nav class="navbar" role="navigation">
						...
						<div class="collapse navbar-collapse navbar-responsive-collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="index.php">Преимущества</a></li>
				...
				<div class="col-md-12">
					...
					<div class="row">
					            <div class="content" >
					                ...
					                <h3 class="black">Ask what you want to know via information below</h3>
					                <h3 class="black">Our location:</h3>
					            <div class="content">
					                ...
					                <script>
					                    ...
					                    DG.then(function() {
					                        map = DG.map('map', {
					                            center: [43.2366, 76.9126],
					                            zoom: 16,

					                        });
					                        DG.marker([43.2366, 76.9126]).addTo(map).bindPopup('Мы находимся здесь!  TechCore');;
					                    });
					                </script>
					            </div>
					        </div>
